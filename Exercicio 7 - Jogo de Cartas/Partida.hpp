...
public:
	...
	//~Partida();
	void addJogadorCarta(string nomeJogador, int numero_pontos_carta, string naipe, int novidade, int indiceJogador);
	...
	void imprimeJogadoresOrdenados(vector<Jogador> jogadoresOrdenados);
};
